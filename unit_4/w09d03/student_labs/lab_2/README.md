...
**NOTE**: You will have to path to the csv files from wherever the postgres app opens up your database in terminal. For example, if it opens the postgres terminal at the root (`~`) and my SEIR-Moss folder is on my desktop, I would path to routes.csv like so: `./Desktop/SEIR-Moss/unit_4/w10d01/student_labs/afternoon/routes.csv`. Your path will look different depending on where your classroom repo is located.
