...
Cut/Paste the routes in your server.js file into `controllers/fruits.js`
...
You can specify when a middleware runs by adding a path as the first parameter to `app.use`.  Edit `server.js`:
